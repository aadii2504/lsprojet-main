...
import { isEmail, passwordIssues, normalizeEmail } from "../registration/Validation";
import { checkDuplicateEmail } from "../registration/Api";
...
export const RegistrationForm = () => {
  ...
  return;
    ...
    // Only backend is source of truth for users now
