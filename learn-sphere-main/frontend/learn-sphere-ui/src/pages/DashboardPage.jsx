  ...
  const [liveSessions] = useState([
    {
      ...
      durationMins: 90,
      thumbnail:
        "https://user-images.githubusercontent.com/108109935/198030893-e0c815ef-28fa-43df-8e8a-fc42243b59fa.png",
      isLive: true,
    },
    {
      id: "ls-102",
      ...
      durationMins: 120,
      thumbnail: "https://i.ytimg.com/vi/YuB3OuF3MUE/maxresdefault.jpg",
      isLive: false,
    },
    {
      id: "ls-103",
      ...
      durationMins: 75,
      thumbnail:
        "https://tse2.mm.bing.net/th/id/OIP.MwSbPCFPXnZnVznutkV8OwHaEK?w=294&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3",
      isLive: false,
    },
  ]);
        ...
        >
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-2">
              <label className="text-sm opacity-80" htmlFor="sort">
                Sort by
              </label>
              <select
                id="sort"
